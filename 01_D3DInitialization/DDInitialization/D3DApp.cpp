...
D3DApp::D3DApp(HINSTANCE hInstance) :
	...
	m_Enable4xMSAA(true),
	m_4xMSAAQuality(0),
	m_MainWNDCaption(L"Direct3D11 Initialization"),
	m_ClientWidth(800),
	m_ClientHeight(600),
...
bool D3DApp::InitDirect3D()
{
	...
	m_pd3d11Device->CheckMultisampleQualityLevels(DXGI_FORMAT_R8G8B8A8_UNORM, 4, &m_4xMSAAQuality);//4个8位数组成，每个成员为[0,1.f]之间
